export const ProductList = {
  ...
  sofa: {
    single_seater: {
      id: 6,
      name: "Single Seater ",
      glbLink: "./models/single_seater.glb",
      desc: "A single seater sofa, a sanctuary of solitude where comfort and elegance intertwine.",
      thumbnail: "./texture/productThumbnail/single_seater.png",
      variation: [
        {
          id: "6001",
          thumbnail: "./texture/fabric15.jpg",
          varDesc:
